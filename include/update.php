 ...
 * @return bool|null
 */
function xoops_module_update_wgphpoffice($module, $prev_version = null)
{
    $ret = null;
    if ($prev_version < 10) {
        $ret = update_wgphpoffice_v10($module);
    }

    $ret = wgphpoffice_check_db($module);

    //check upload directory
	include_once __DIR__ . '/install.php';
    $ret = xoops_module_install_wgphpoffice($module);
 ...
 * @return bool
 */
function update_wgphpoffice_v10($module)
{
    global $xoopsDB;
 ...
 * @return bool
 */
function wgphpoffice_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('wgphpoffice_images');
    $field   = 'img_exif';

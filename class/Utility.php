...
class Utility
{
    ...
    {
        /*
        $colors['red']       = ['code' => '#ff2323', 'descr' => \_MA_WGSIMPLEACC_COLOR_RED];
        $colors['darkred']   = ['code' => '#aa3214', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKRED];
        $colors['orange']    = ['code' => '#ffa03c', 'descr' => \_MA_WGSIMPLEACC_COLOR_ORANGE];
        $colors['yellow']    = ['code' => '#fff550', 'descr' => \_MA_WGSIMPLEACC_COLOR_YELLOW];
        $colors['green']     = ['code' => '#64c800', 'descr' => \_MA_WGSIMPLEACC_COLOR_GREEN];
        $colors['darkgreen'] = ['code' => '#646400', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKGREEN];
        $colors['blue']      = ['code' => '#37a0eb', 'descr' => \_MA_WGSIMPLEACC_COLOR_BLUE];
        $colors['darkblue']  = ['code' => '#145f96', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKBLUE];
        $colors['purple']    = ['code' => '#9966cc', 'descr' => \_MA_WGSIMPLEACC_COLOR_PURPLE];
        $colors['grey']      = ['code' => '#999999', 'descr' => \_MA_WGSIMPLEACC_COLOR_GREY];
        */
        $colors[] = ['name' => 'red',       'code' => '#ff2323', 'descr' => \_MA_WGSIMPLEACC_COLOR_RED];
        $colors[] = ['name' => 'darkred',   'code' => '#aa3214', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKRED];
        $colors[] = ['name' => 'orange',    'code' => '#ffa03c', 'descr' => \_MA_WGSIMPLEACC_COLOR_ORANGE];
        $colors[] = ['name' => 'yellow',    'code' => '#fff550', 'descr' => \_MA_WGSIMPLEACC_COLOR_YELLOW];
        $colors[] = ['name' => 'green',     'code' => '#64c800', 'descr' => \_MA_WGSIMPLEACC_COLOR_GREEN];
        $colors[] = ['name' => 'darkgreen', 'code' => '#646400', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKGREEN];
        $colors[] = ['name' => 'blue',      'code' => '#37a0eb', 'descr' => \_MA_WGSIMPLEACC_COLOR_BLUE];
        $colors[] = ['name' => 'darkblue',  'code' => '#145f96', 'descr' => \_MA_WGSIMPLEACC_COLOR_DARKBLUE];
     ...
     */
    public static function getFormFilterPeriod($filterYear, $filterType, $filterMonthFrom, $filterYearFrom, $filterMonthTo, $filterYearTo, $op = 'list', $action = false)
    {
        ...
        if (Constants::FILTER_PYEARLY == $period_type) {
            ...
            $filterYearSelect->setExtra('onchange="submit()"');
            $form->addElement($filterYearSelect, true);
        } else {
            $filterType = new \XoopsFormRadio(\_MA_WGSIMPLEACC_FILTERTYPE, 'filterType', $filterType);
            $filterType->addOption(Constants::FILTER_TYPEALL, \_MA_WGSIMPLEACC_SHOW_ALL);
            $filterType->addOption(Constants::FILTER_TYPECUSTOM, \_MA_WGSIMPLEACC_SHOW_CUSTOM);
            $form->addElement($filterType);
            //linebreak

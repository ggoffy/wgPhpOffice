...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Calculation\DateTime;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet\AutoFilter objects
                $this->{$key} = [];

...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Renderer\IRenderer;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Collection\Memory;
use XoopsModules\Wgphpoffice\Psr\Http\Client\ClientInterface;
use XoopsModules\Wgphpoffice\Psr\Http\Message\RequestFactoryInterface;
use XoopsModules\Wgphpoffice\Psr\SimpleCache\CacheInterface;

class Settings
{
    /**
     * Class name of the chart renderer used for rendering charts
     * eg: XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Renderer\JpGraph.
     *
     * @var string
     */

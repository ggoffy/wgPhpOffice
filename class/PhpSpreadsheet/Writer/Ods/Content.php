...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Row;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Exception;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Ods;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Ods\Cell\Comment;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row): void
    {
        ...
        while ($cells->valid()) {
            /** @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();

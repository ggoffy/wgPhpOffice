...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Cell;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Coordinate;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Chart;
...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Font as SharedFont;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $pSheet \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Alignment).
     *
     * @param Alignment $pStyle \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font).
     *
     * @return array
     */
    ...
    private function generateRowWriteCell(&$html, $pSheet, $coordinate, $cellType, $cellData, $colSpan, $rowSpan, $cssClass, $colNum, $sheetIndex, $pRow): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf) {
            ...
            //** Necessary redundant code for the sake of \XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Pdf **
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $pSheet) {
            ...
            if ($orientation === \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {

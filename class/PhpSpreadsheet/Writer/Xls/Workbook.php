...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font $font)
    {
    ...
    private function writeBoundSheet($sheet, $offset): void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;

...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Coordinate;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\DataType;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\DataValidation;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\RichText\RichText;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\RichText\Run;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\StringHelper;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Xls;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Alignment;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Border;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Color;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Conditional;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Fill;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Protection;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\PageSetup;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\SheetView;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Exception as WriterException;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
...
//        if ($this->firstColumnIndex > 255) $this->firstColumnIndex = 255;
     ...
     *
     * @see \XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks(): void
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher $pValue
     */
    public function setEscher(?\XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher $pValue = null): void
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional): void
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:

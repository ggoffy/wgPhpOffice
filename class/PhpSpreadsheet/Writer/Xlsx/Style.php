...
class Style extends WriterPart
{
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style $pStyle Style
     * @param Spreadsheet $spreadsheet Workbook
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style $pStyle, Spreadsheet $spreadsheet): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', 0);
     ...
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style $pStyle Style
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style $pStyle): void
    {
        // dxf
     ...
     *
     * @return \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style[] All styles in PhpSpreadsheet
     */
    ...
    public function allFills(Spreadsheet $spreadsheet)
    {
        ...
        /** @var \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style $style */

...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\AutoFilter\Column;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\SheetView;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeCellFormula(XMLWriter $objWriter, string $cellValue, Cell $pCell): void
    {
        ...
        if (is_string($calculatedValue)) {
            if (\XoopsModules\Wgphpoffice\PhpSpreadsheet\Calculation\Functions::isError($calculatedValue)) {
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $pSheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$pSheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \XoopsModules\Wgphpoffice\PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)

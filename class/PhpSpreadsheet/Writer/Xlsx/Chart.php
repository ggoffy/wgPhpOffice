...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Axis;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\DataSeries;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\DataSeriesValues;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\GridLines;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Layout;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Legend;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\PlotArea;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     * @param Axis $yAxis
     */
    private function writePlotArea(XMLWriter $objWriter, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, ?Title $xAxisLabel = null, ?Title $yAxisLabel = null, ?Axis $xAxis = null, ?Axis $yAxis = null, ?GridLines $majorGridlines = null, ?GridLines $minorGridlines = null): void
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     */

...
class Drawing
{
     ...
     *
     * @param int $pValue Value in pixels
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return int Value in cell dimension
     */
    public static function pixelsToCellDimension($pValue, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
     ...
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($pValue, \XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();

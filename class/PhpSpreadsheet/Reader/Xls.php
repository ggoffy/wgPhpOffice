...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\NamedRange;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\RichText\RichText;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\CodePage;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Date;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\File;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\OLE;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\OLERead;
...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;

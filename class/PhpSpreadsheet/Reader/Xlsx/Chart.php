...
namespace XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
     ...
     *
     * @return \XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Chart
     */
    public static function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \XoopsModules\Wgphpoffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, $dispBlanksAs, $XaxisLabel, $YaxisLabel);

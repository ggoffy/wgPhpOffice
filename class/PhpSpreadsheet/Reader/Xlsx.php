...
namespace XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader;

use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Coordinate;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell\Hyperlink;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\DefinedName;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Security\XmlScanner;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\Chart;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Reader\Xlsx\Styles;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\ReferenceHelper;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\RichText\RichText;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Settings;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Date;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Drawing;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\File;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Shared\Font;
...
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Borders;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Color;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\NumberFormat;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Protection;
use XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Style;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if ($xmlDrawingChildren->oneCellAnchor) {
                                            foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Drawing();
    ...
    private static function readStyle(Style $docStyle, $style): void
    {
        ...
        if (isset($style->font)) {
            ...
            if (isset($style->font->u) && !isset($style->font->u['val'])) {
                $docStyle->getFont()->setUnderline(\XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u) && !isset($run->rPr->u['val'])) {
                            $objText->getFont()->setUnderline(\XoopsModules\Wgphpoffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
    ...
    /**
     * @param \XoopsModules\Wgphpoffice\PhpSpreadsheet\Worksheet\Drawing $objDrawing

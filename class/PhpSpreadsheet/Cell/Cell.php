...
namespace XoopsModules\Wgphpoffice\PhpSpreadsheet\Cell;
        ...
        if ($this->dataType == DataType::TYPE_FORMULA) {
            try {
                ...
                if (($ex->getMessage() === 'Unable to access External Workbook') && ($this->calculatedValue !== null)) {
                    ...
                    return \XoopsModules\Wgphpoffice\PhpSpreadsheet\Calculation\Functions::NAME();
                }

                throw new \XoopsModules\Wgphpoffice\PhpSpreadsheet\Calculation\Exception(

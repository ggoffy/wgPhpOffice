...
$vendorDirPath = XOOPS_ROOT_PATH . '/modules/wgphpoffice/lib/';
$dompdfPath = $vendorDirPath . '/Pdf/Dompdf';
if (file_exists($dompdfPath)) {
    define('DOMPDF_ENABLE_AUTOLOAD', false);
    Settings::setPdfRenderer(Settings::PDF_RENDERER_DOMPDF, $vendorDirPath . '/Pdf/Dompdf');
}

// Set writers
$writers = array('Word2007' => 'docx', 'ODText' => 'odt', 'HTML' => 'html', 'PDF' => 'pdf', 'RTF' => 'rtf');
